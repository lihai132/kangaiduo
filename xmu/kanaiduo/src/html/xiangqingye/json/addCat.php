...
$sql = "SELECT * FROM cart WHERE gooid = '$id'";
...
if(mysqli_num_rows($result) == 0)
{
  ...
  $totalPrice = $price;
  /* 插入 */
  $insetSql = "INSERT INTO `cart` (`cartid`, `gooid`, `num`, `price`,`total`) VALUES (NULL, '$id', 1, '$price','$totalPrice')";
  // echo "执行插入操作";
  // echo $insetSql;
  mysqli_query($con, $insetSql);
    ...
    /* 更新 */
    $updateSql = "UPDATE cart SET num='$num',total='$total' WHERE gooid=' $id'"; 
